...
try:
    from MediProAPI.apps.subscription.models import ClientSubscription, SubscriptionPlan
except ImportError:
...
def account_create(request):
    ...
    if hasattr(auth_user, 'client_profile'):
        from MediProAPI.apps.subscription.services.access import check_can_create_user

...
from EduraAPI.apps.modules.catalog import ADMIN_MODULES, CLIENT_MODULES
from EduraAPI.apps.modules.models import Module, UserModule
from EduraAPI.apps.subscription.models import SubscriptionType
